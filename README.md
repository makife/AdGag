...
`flutter analyze`: 0 issues. `flutter test`: 59/59. Rebuilt `app-debug.apk` with both fixes — not yet reinstalled/retested on the device that found the bugs (next step).
